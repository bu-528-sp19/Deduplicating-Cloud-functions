...
if __name__ == "__main__":
    ...
    addFunctionIfNotExist(couch,"secondFunction")
    addInputDataIfNotExist(couch,"secondFunction","firstDataChecksum")
    addMinioRef(couch, "secondFunction", "firstDataChecksum","test2/abc.img")
